...
const Navbar = () => {
  ...
  return (
    <nav
      className={`navbar px-5 lg:px-20 ${
    ...
    >
      ...
      <motion.nav
        ...
        className={`navbar-menu border rounded-md bg-white lg:hidden ${
          ...
          {navItems.map((item, index) => (
            <motion.li key={index}>
              <Link
                ...
                className="menu-item text-teal-500 text-xl px-10"
              >
                {item}
              </Link>
            </motion.li>
          ...
          {navItems.map((item, index) => (
            <li key={index}>
              <Link
                ...
                className="menu-item text-teal-500 text-2xl mx-2"
              >
                {item}
              </Link>
            </li>
